...
const topSkillsCards = [
  { name: "PHP", icon: <PhpIcon size={38} /> },
  { name: "WordPress", icon: <WordPressIcon size={38} /> },
  { name: "Laravel", icon: <LaravelIcon size={38} /> },
  { name: "MySQL", icon: <MySqlIcon size={38} /> },
  { name: "HTML5", icon: <Html5Icon size={38} /> },
  { name: "CSS3", icon: <Css3Icon size={38} /> },
  { name: "JavaScript", icon: <JsIcon size={38} /> },
];
...
const progressSkills = [
  {
    name: "PHP",
    percentage: "90%",
    icon: <PhpIcon size={26} />,
  },
  {
    name: "WordPress",
    percentage: "85%",
    icon: <WordPressIcon size={26} />,
  },
  {
    name: "Laravel, CI",
    percentage: "95%",
    icon: <LaravelIcon size={26} />,
  },
  {
    name: "MySQL",
    percentage: "80%",
    icon: <MySqlIcon size={26} />,
  },
  {
    name: "HTML5, CSS3",
    percentage: "90%",
    icon: <Html5Icon size={26} />,
  },
  {
    ...
    <div className="my-skills-wrapper" ref={ref}>
      <div className="my-skills-container">
        ...
        >
          ...
          {/* 7 Tech Badges Row */}
          <div className="my-skills-cards-row">
            {topSkillsCards.map((card, idx) => (
              <motion.div
                key={card.name}
                className="my-skill-tech-card"
                ...
                whileHover={{
                  y: -6,
                  boxShadow: "0 12px 26px -4px rgba(29, 114, 254, 0.18)",
                  borderColor: "rgba(29, 114, 254, 0.4)",
                  transition: { type: "spring", stiffness: 350, damping: 18 },
                }}
              >
                <div className="my-skill-card-icon">{card.icon}</div>
                <span className="my-skill-card-name">{card.name}</span>
              </motion.div>
            ))}
          </div>
          ...
          <div className="my-skills-subheading">
            <span className="bolt-icon" role="img" aria-label="lightning">⚡</span>
            <span>Skills you can rely on for your next projects.</span>
          </div>
          ...
          <div className="my-skills-progress-list">
            {progressSkills.map((item, idx) => (
              <div key={item.name} className="my-skill-progress-row">
                <div className="my-skill-icon-pill">
                  {item.icon}
                </div>
                ...
                <span className="my-skill-pct-label">{item.percentage}</span>
              </div>
            ))}
          </div>
        </motion.div>
